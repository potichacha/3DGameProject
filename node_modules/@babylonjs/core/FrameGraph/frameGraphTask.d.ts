...
export declare abstract class FrameGraphTask {
    ...
    protected readonly _internalDependencies: Set<FrameGraphTextureHandle>;
    ...
    protected _addInternalDependencies(dependencies: FrameGraphTextureHandle | FrameGraphTextureHandle[]): void;
